...
from stats import stats_printer, print_percentile_stats, print_error_report, print_stats, save_mysql
...
def parse_options():
    ...
    #"add option to save to mysql"
    parser.add_option(
        '--mysql',
        action='store_true',
        dest='mysql',
        default=False,
        help="save stats to mysql"
    )
